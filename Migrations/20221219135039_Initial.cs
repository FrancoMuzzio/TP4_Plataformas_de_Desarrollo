    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Usuario",
                columns: new[] { "id", "apellido", "bloqueado", "dni", "intentosFallidos", "isAdmin", "isVip", "mail", "nombre", "password" },
                values: new object[,]
                {
                    { 1, "Muzzio", false, 40009479, 0, true, true, "franco.muzzio@davinci.edu.ar", "Franco", "1234" },
                    { 2, "Piñeiro", false, 63309307, 0, true, false, "fiorella.piñeiro@davinci.edu.ar", "Fiorella", "1234" },
                    { 3, "Markauskas", false, 32677773, 0, true, false, "magalí.markauskas@davinci.edu.ar", "Magalí", "1234" },
                    { 4, "Sassano", false, 21035623, 0, true, false, "martín.sassano@davinci.edu.ar", "Martín", "1234" },
                    { 5, "Giudice", false, 23391008, 0, true, false, "agustín.giudice@davinci.edu.ar", "Agustín", "1234" },
                    { 6, "Maubert", false, 45686773, 0, true, false, "alexis.maubert@davinci.edu.ar", "Alexis", "1234" },
                    { 7, "Di Marco", false, 84355987, 0, false, false, "marcos.dimarco@davinci.edu.ar", "Marcos", "1234" },
                    { 8, "Gutierrez", false, 40563444, 2, false, false, "juliana.gutierrez@davinci.edu.ar", "Juliana", "1234" },
                    { 9, "Houseman", false, 30447163, 0, false, false, "ariana.houseman@davinci.edu.ar", "Ariana", "1234" },
                    { 10, "Poggi", false, 73026363, 1, false, false, "pedro.poggi@davinci.edu.ar", "Pedro", "1234" },
                    { 11, "Ramirez", true, 39440793, 0, false, false, "lazaro.ramirez@davinci.edu.ar", "Lazaro", "1234" }
                });
